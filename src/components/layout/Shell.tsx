...
// ── Ferramentas de apoio — não sequenciais, acessadas conforme a
// necessidade do projeto, não uma etapa obrigatória do fluxo ──────
const FERRAMENTAS = [
    ...
    <div className="shell">
      ...
      <div className="sidebar">
        ...
        <div className="sidebar-tools">
          <div className="sidebar-tools-label">Ferramentas</div>
